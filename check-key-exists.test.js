...
test.describe('Performance Tests', () => {
    test('== undefined', async ({ page }) => {
        await page.evaluate(({ testPerformance, test1 }) => {
            const testObj = {
                a: 28, b: 82, c: "hello", d: 983, e: 'lara', o: "key", f: '82828', g: 8,
                h: 45, i: "world", j: 123, k: 'test', l: 999, m: 'data', n: 456, p: 'value',
                q: 789, r: 'example', s: 321, t: 'sample', u: 654, v: 'info', w: 987, x: 'text',
        ...
        }, { testPerformance: testPerformance.toString(), test1: test1.toString() });
    });
    ...
    test('"key" in testObj', async ({ page }) => {
        ...
        await page.evaluate(({ testPerformance, test2 }) => {
            const testPerformanceFn = new Function('return ' + testPerformance)();
        ...
        }, { testPerformance: testPerformance.toString(), test2: test2.toString() });
    });
    ...
    test('hasOwnProperty', async ({ page }) => {
        ...
        await page.evaluate(({ testPerformance, test3 }) => {
            const testPerformanceFn = new Function('return ' + testPerformance)();
        ...
        }, { testPerformance: testPerformance.toString(), test3: test3.toString() });
    });
});
